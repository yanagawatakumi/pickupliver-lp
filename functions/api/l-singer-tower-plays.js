...
const ALLOWED_MODES = new Set(['vol3', 'vol4', 'vol5', 'allstar', 'allstar-vol4', 'allstar-vol5']);
...
function normalizeMode(raw) {
  ...
  if (!ALLOWED_MODES.has(value)) throw new Error(`mode must be one of: ${Array.from(ALLOWED_MODES).join(', ')}`);
  return value;
}
